...
class DepartmentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Department entity")
        ...
        .repeat(2) {
            ...
            .get("/services/organization/api/departments")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new department")
            .post("/services/organization/api/departments")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "code":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/organization${new_department_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created department")
            .delete("/services/organization${new_department_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
